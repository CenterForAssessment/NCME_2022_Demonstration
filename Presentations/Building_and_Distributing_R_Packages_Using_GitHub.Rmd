...
meta() %>%
  meta_general(
    description = "NCME 2022 Demonstration Presentation",
  ...
  meta_social(
    ...
    image = "https://github.com/CenterForAssessment/NCME_2022_Demonstration/raw/main/docs/presentations/assets/img/coverImageSlide_Building_Distributing.png",
