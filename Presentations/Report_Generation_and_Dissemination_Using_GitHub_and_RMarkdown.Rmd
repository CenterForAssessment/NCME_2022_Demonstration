...
date: "`r toOrdinal::toOrdinalDate(Sys.Date())`<br>NCME 2022 Annual Meeting"
output:
  xaringan::moon_reader:
    seal: false
    css: [default, libs/cfa_assets/css/cfa-a.css, libs/cfa_assets/css/cfa-a-fonts.css]
    lib_dir: libs
    nature:
      ratio: 16:9
...
.date[
### `r toOrdinal::toOrdinalDate(Sys.Date())`<br />NCME 2022 Annual Meeting
]
...
<div class="footer" style="left: 5%;"><img src="libs/cfa_assets/img/cc.svg" style = "max-width: 40%; opacity: 0.5;"></img></div>
<div class="footer" style="left: 7.5%;"><img src="libs/cfa_assets/img/by.svg" style = "max-width: 40%; opacity: 0.5;"></img></div>
...
```{r cfa_extra, echo=FALSE, warning=FALSE}
# VERY cludgy at this point. All asset paths (except R code - not copied) 
# need to be set as `libs/cfa_assets/...` in the .Rmd YAML and text.
# This code then copies them there from ./Presentations/cfa_assets
# NOTE: This wouldn't be necessary if 1) self_contained = FALSE (not smart/too big)
# or 2) presentation not moved as it is under `build_presentations`.
source("cfa_assets/R/xaringan_cfa.R")
xaringan_cfa(
  theme = "cfa-a", # default -&- only choice :-)
  img = TRUE, # c("CFA_Logo_alpha_07.svg", "cc.svg", "by.svg"), # copies all... can we subset?
  asset_dir = "cfa_assets")

# Direct use for figures not wrapped in `knitr` chunks
# assign to fig.cp to suppress output. 
# Gives warning about directory not existing, but they get copied anyway...
my_figs <- htmltools::htmlDependency(
  "fig", "0.0.1", "cfa_assets/fig",
  all_files = TRUE)
fig.cp <- htmltools::copyDependencyToDir(my_figs, "libs/cfa_assets", mustWork = TRUE)
```
...
# enabling audible tone for slide transitions (accessability for vision impared)
...
<img src="libs/cfa_assets/fig/wp_cover.png" width="30%">
<img src="libs/cfa_assets/fig/pgdrpt_cover.png" width="30%">
<img src="libs/cfa_assets/fig/nciea_cover.png" width="33%">

---

##  Format comparisons

<img src="libs/cfa_assets/fig/pgdrpt_quad1.png" width="33%">
<img src="libs/cfa_assets/fig/nciea_quad1.png" width="36%">

---

##  Format comparisons

<img src="libs/cfa_assets/fig/pgdrpt_quad2.png" width="33%">
<img src="libs/cfa_assets/fig/nciea_quad2.png" width="36%">
